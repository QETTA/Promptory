...
export function SlackMock({ messages, className, animated = true }: SlackMockProps) {
  ...
  return (
    <div
      className={cn(
        "slack-shell w-full max-w-md transition-all duration-300 hover:-translate-y-0.5",
        className
      )}
    >
      {/* Slack Header */}
        ...
        {messages.slice(0, visibleCount).map((message, index) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="slack-message-bubble mt-1.5 px-3 py-2 text-sm leading-relaxed">
                {message.content}
              </div>
