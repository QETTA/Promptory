...
export const metadata: Metadata = {
  title: "Interactive demo wedge — Promptory",
  description:
    "Promptory의 request-to-resolution 제품 구조를 보여 주는 public audit 데모입니다. 핵심 제품이 아니라 인터랙티브 체험면으로 위치시킵니다.",
};
...
export default async function OptimizePage({
  ...
  return (
    <div className="pb-16">
      <Hero
        eyebrow="Interactive demo wedge"
        theme="workspace"
        tone="light"
        title={
          isReady
            ? "데모용 공개 진단이 준비됐습니다"
            : needsManualReview
              ? "지원 가능한 공개 표면인지 먼저 확인해야 합니다"
              : needsTuning
                ? "데모 입력값을 조금 더 보정해 주세요"
                : "공개 표면 진단 데모를 시작하세요"
        }
        body={
          isReady && parsed?.ok ? (
            ...
            <>
              <p>이 화면은 제품 코어가 아니라 public audit wedge 입니다. {supportedChannelHeadline} URL 중 하나를 넣고 public audit 데모부터 시작하세요.</p>
            </>
          )
        }
        actions={
          <>
            <CTAButton href="/solutions" size="sm" variant="outline">Action Pack 보기</CTAButton>
            <CTAButton href="/pilot" size="sm">Pilot 구조 보기</CTAButton>
          </>
        }
        ...
        {!parsed ? (
          <div className="grid gap-4 lg:grid-cols-[minmax(0,1.2fr)_minmax(300px,0.8fr)]">
            <Card variant="strong" className="p-5 sm:p-6">
              ...
              <h2 className="section-title mt-2 text-[var(--slate-950)]">이 데모는 제품 코어가 아니라 인터랙티브 웨지입니다</h2>
              <p className="mt-3 text-sm leading-7 text-[var(--slate-700)]">
                URL을 넣고 공개 표면과 Ask 답변을 묶어, request-to-resolution 제품이 어떤 식으로 판단하고 추천안을 만드는지 체험하게 합니다.
              </p>
              ...
              <Card variant="tint" className="p-5">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  ...
                  <CTAButton
                    ...
                    telemetryPayload={{ href: "/solutions", source: "optimize_summary" }}
                    variant="outline"
                    size="sm"
                  >
                    실행 팩 보기
            ...
            <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_320px]">
              ...
              <div className="hidden space-y-4 xl:sticky xl:top-24 xl:block xl:self-start">
                ...
                <Card variant="tint" className="p-5 sm:p-6">
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    <CTAButton href="/solutions" variant="outline" size="sm">
                      실행 팩 둘러보기
                    </CTAButton>
                  </div>
                </Card>
