          ...
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            <AnimatedSection direction="left" className="flex flex-col gap-6">
              ...
              <div className="flex flex-wrap gap-3 pt-2">
                <CTAButton href="/contact" size="lg" className="btn-shine hover:scale-105 transition-transform bg-indigo-600 hover:bg-indigo-700">
                  데모 요청하기
                </CTAButton>
        ...
        <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          <AnimatedSection>
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              ...
              <CTAButton href="/contact" variant="outline" size="lg" className="hover-lift border-indigo-200 hover:bg-indigo-50">
                한국 URL 보내기
              </CTAButton>
            </div>
          </AnimatedSection>
