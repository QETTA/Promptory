    ...
    <div className="pb-16">
      {!canShowSignup ? (
        ...
        <>
          <Hero
            eyebrow="계정 만들기"
            title="채널 진단과 작업 흐름을 한 계정으로 엽니다"
            body="Promptory 계정을 만들고 메일 인증을 마치면 URL 진단 저장, 주문 확인, 라이브러리 보관, 제작실 작업까지 같은 작업흐름으로 이어집니다."
            tone="light"
          />
          <div className="mx-auto grid max-w-6xl gap-6 px-4 py-7 sm:px-6 sm:py-8 lg:grid-cols-[minmax(0,1fr)_420px] lg:px-8">
            <div className="grid gap-4 self-start sm:grid-cols-2 lg:grid-cols-1">
              ...
              <Card variant="default" className="rounded-[1.5rem] p-5">
                <p className="section-kicker text-[var(--slate-500)]">연결 흐름</p>
