    ...
    <div className="pb-16">
      <Hero
        ...
        body={
          <>
            <p>{outcomeHeadline}</p>
            <p>이 상세는 URL 진단 뒤에 어떤 실행 팩을 붙일지 고르는 결정 표면입니다.</p>
          </>
        }
        actions={
        ...
        aside={
          <div className="rounded-[1rem] border border-[var(--line-strong)] bg-[var(--surface-1)] p-5">
            <p className="section-kicker text-[var(--slate-500)]">결정 요약</p>
      ...
      <div className="mx-auto grid max-w-6xl gap-8 px-4 py-8 sm:px-6 lg:grid-cols-[minmax(0,1fr)_320px] lg:px-8">
        <div className="space-y-2 lg:space-y-0">
          <Section eyebrow="이 팩이 해결하는 문제" title="이걸로 무엇을 바꾸는지" className="border-b border-[var(--line)]">
          ...
          <Section eyebrow="포함 항목" title="구매하면 받는 것" className="border-b border-[var(--line)]">
          ...
          <Section eyebrow="적용 순서" title="설치 방법" className="border-b border-[var(--line)]">
            <div className="grid gap-3">
          ...
          <Section eyebrow="추천 상황" title="누구에게 적합한지" className="border-b border-[var(--line)]">
          ...
          <Section eyebrow="적용 예시" title="미리보기와 예시">
            <div className="grid gap-3 md:grid-cols-2">
