...
import { optimizeReadinessCopy } from "@/lib/optimize-copy";
...
export type ChannelSnapshot = {
  ...
  readinessStatus: SnapshotCheckStatus;
...
export function buildChannelSnapshot(parsed: ParsedChannelInputSuccess): ChannelSnapshot {
  ...
  return {
    confidenceLabel,
    confidenceReason,
    readinessStatus: canSnapshot ? "pass" : supported ? "warn" : "fail",
    checks,
    ...
    pathValue,
    readyLabel: canSnapshot
      ? optimizeReadinessCopy.readyLabel
      : supported
        ? optimizeReadinessCopy.tuningLabel
        : optimizeReadinessCopy.manualReviewLabel,
